...
<div id="header">
	...
	<div id="auth_block">
		...
		?>
				...
				<a role="button" class="float-right btn btn-outline-primary btn-log log-in" href="/site/profile/form_auth.php" id="link_auth"><svg xmlns="http:/.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
