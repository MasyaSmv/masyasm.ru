            ...
            <div class="wrDwse" style="top: 56px;">
                ...
                <div class="tC9kZd">
                    <nav class="tbyFuf">
                        <ul class="b3qkse">
                            <li class="BBRNg">
                                <a href="/site/profile/personal_area/main.php" class="VZLjze Wvetm zCVEd EhlvJf">
                                    <div class="iKN8Oe">
                                        <style nonce="">
                                            .HJOYVi6 {
                                                width: 24px;
                            ...
                            <li class="BBRNg">
                                <a href="/site/profile/personal_area/subscriptions.php" class="VZLjze Wvetm zCVEd EhlvJf KKjvXb">
                                    <div class="iKN8Oe">
                                        <figure class="z7VTQb" style="width: nullpx; height: nullpx;">
                                    ...
                                    <div class="ugt2L aK2X8b iDdZmf">
                                        <a href="/" class="VZLjze Wvetm N5YmOc kJXJmd bvW4md I6g62c">
                                            <header class="mSUZQd">
                                                ...
                                                <div class="CljqTd">
                                                    <div class="fxHFgc">
                                                        <figure class="HJOYV HJOYVc7" style=" height: 96px;"><img class="YPzqGd" src="/site/img/subscriptions/credit_card_min.png"></figure> <!--width: 96px; -->
                                                    </div>
                                                    <div class="ueiHJd">
                                                        <figure class="HJOYV HJOYVc8 P0ukfb" style=" height: 112px;"><img class="YPzqGd" src="/site/img/subscriptions/credit_card.png"></figure> <!--width: 316px; -->
                                                    </div>
                                                </div>
                                            </header>
                                        </a>
                                    ...
                                    <div class="ugt2L aK2X8b iDdZmf">
                                        <a href="/" class="VZLjze Wvetm N5YmOc kJXJmd bvW4md I6g62c">
                                            <header class="mSUZQd">
                                                ...
                                                <div class="CljqTd">
                                                    <div class="fxHFgc">
                                                        <figure class="HJOYV HJOYVc9" style="height: 96px;"><img class="YPzqGd" src="/site/img/subscriptions/shopping_box_min.png"></figure>
                                                    </div>
                                                    <div class="ueiHJd">
                                                        <figure class="HJOYV HJOYVc10 P0ukfb" style="height: 112px;"><img class="YPzqGd" src="/site/img/subscriptions/shopping_box.png"></figure>
                                                    </div>
                                                </div>
                                            </header>
                                        </a>
                                    ...
                                    <div class="ugt2L aK2X8b iDdZmf">
                                        <a href="/" class="VZLjze Wvetm N5YmOc kJXJmd bvW4md I6g62c">
                                            <header class="mSUZQd">
                                                ...
                                                <div class="CljqTd">
                                                    <div class="fxHFgc">
                                                        <figure class="HJOYV HJOYVc11" style="height: 96px"><img class="YPzqGd" src="/site/img/subscriptions/cat_subscribe_min.png"></figure>
                                                    </div>
                                                    <div class="ueiHJd">
                                                        <figure class="HJOYV HJOYVc12 P0ukfb" style="height: 112px"><img class="YPzqGd" src="/site/img/subscriptions/subscribe.png"></figure>
                                                    </div>
                                                </div>
                                            </header>
                                        </a>
                                    ...
                                    <div class="ugt2L aK2X8b iDdZmf">
                                        <a href="/" class="VZLjze Wvetm N5YmOc kJXJmd bvW4md I6g62c">
                                            <header class="mSUZQd">
                                                ...
                                                <div class="CljqTd">
                                                    <div class="fxHFgc">
                                                        <figure class="HJOYV HJOYVc13" style=" height: 96px"><img class="YPzqGd" src="/site/img/subscriptions/credit_card_min.png"></figure>
                                                    </div>
                                                    <div class="ueiHJd">
                                                        <figure class="HJOYV HJOYVc14 P0ukfb" style="height: 96px"><img class="YPzqGd" src="/site/img/subscriptions/credit_card.png"></figure>
                                                    </div>
                                                </div>
                                            </header>
                                        </a>
